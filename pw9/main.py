...
def main(window):
    ...
    num_std_btn = tk.Button(window, text="Number of student", command=std_num(window))
    num_std_btn.pack()

    num_course_btn = tk.Button(window, text="Number of student", command=course_num(window))
    num_course_btn.pack()

    add_mark_btn = tk.Button(window, text="Add mark")
    add_mark_btn.pack()

    show_student_btn = tk.Button(window, text="Show student list", command=show_students(students, window))
    show_student_btn.pack()

    show_course_btn = tk.Button(window, text="Show course list", command=show_course(courses, window))
    show_course_btn.pack()

    show_gpa_btn = tk.Button(window, text="Show GPA", command=show_gpa(students, window))
    show_gpa_btn.pack()

    # exit_btn = tk.Button(window, text="Exit", command=)
    # exit_btn.pack()
